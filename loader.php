 ...
 */
if ( !function_exists( 'shoestrap_slider_add_gallery_type' ) ) :
...
if ( !class_exists( 'Jetpack_Gallery_Settings' ) ) :
	 ...
	 */
	if ( !function_exists( 'shoestrap_slider_admin_init' ) ) :
	 ...
	 */
	if ( !function_exists( 'shoestrap_slider_print_media_templates' ) ) :
